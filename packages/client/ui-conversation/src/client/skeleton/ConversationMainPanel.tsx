import { HiveStatus } from '@deepseek-ai/dsh-client-ui-primitives'
...
export function ConversationMainPanel(props: ConversationSlotProps) {
  ...
  return (
    <div className={css.root} data-phase={phase}>
      <div className={css.workbenchTopbar}>
        <div><span className={css.eyebrow}>{props.t('shell.kicker')}</span>
          <h2>{props.t('shell.title')}</h2></div>
        <HiveStatus active={session?.running === true} />
      </div>
