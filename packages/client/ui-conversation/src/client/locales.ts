...
export const zh = {
  ...
  'hero.preview': '预览版',
  'hero.kicker': 'DEEPSEEK HARNESS • 你的工作区',
  'hero.description': '探索文件、构建实用成果，并查看每一步。工具和模型汇集在同一个工作台。',
  'hero.action.explore': '探索工作区',
  'hero.action.build': '构建实用功能',
  'hero.action.review': '审查我的更改',
  'hero.action.explain': '解释项目架构',
  'hero.prompt.explore': '探索此工作区，总结其结构并建议下一步。',
  'hero.prompt.build': '先检查工作区，再帮助我规划一项实用的项目改进。',
  'hero.prompt.review': '审查当前更改，查找错误和回归问题。',
  'hero.prompt.explain': '解释此项目的架构以及主要组件如何协同工作。',
  'shell.kicker': '工作台',
  'shell.title': '让好想法成为成果。',
...
export const en = {
  ...
  'hero.headline': 'A little curiosity. Real work.',
  'hero.preview': 'Preview',
  'hero.kicker': 'DEEPSEEK HARNESS • YOUR WORKSPACE',
  'hero.description': 'Explore your files, build something useful, and follow every step. Your tools and models, together in one workbench.',
  'hero.action.explore': 'Explore this workspace',
  'hero.action.build': 'Build something useful',
  'hero.action.review': 'Review my changes',
  'hero.action.explain': 'Explain the architecture',
  'hero.prompt.explore': 'Explore this workspace and summarize its structure and useful next steps.',
  'hero.prompt.build': 'Help me plan a useful improvement to this project. Inspect the workspace first.',
  'hero.prompt.review': 'Review the current changes for bugs and regressions.',
  'hero.prompt.explain': 'Explain the architecture of this project and how its main components work together.',
  'shell.kicker': 'WORKBENCH',
  'shell.title': 'Make room for good work.',
